...
//        var styles_array = ["color: #888787", " font-family: Arial, Geneva, sans-serif", " font-size: 13px", " line-height: 18px", ""]
        ...
        for(var i=0; i< array1 .length; i++) {
            if(array1[i] === "color") {
//                alert("colour of font in td is" + array2[i]);
                var font_color = array2[i]
                font_color = font_color.toString();
                $('.font_styles > #font_color').val(font_color)
//                $('.font_styles > #font_color').html(font_color)
//                $('.font_styles').css('color', font_color).append(font_color)
            }
        }
...
//                $('.font_styles > #font_size').val(font_size)
//                $('.font_styles > #font_size').html(font_size)
...
//                $('.font_styles > #font_family').prepend(font_family)
//                $("select option:contains(Helvetica)").attr('selected', true);
                $("select#font_family option:contains(" + array2[i] + ")").attr('selected', true);
//                $('.font_styles > #font_family').html(font_family)
                //                $('.font_styles').css('color', font_color).append(font_color)
            }
        }
...
//                $('.font_styles > #line_height').html(line_height)
                //                $('.font_styles').css('color', font_color).append(font_color)
            }
        }
