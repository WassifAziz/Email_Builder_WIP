...
! function(a) {
    ...
    var b = function(c, d) {
        ...
        })), this.browser = b.browser(), this.disabledList = [], this._id = ++b.count, this._events = {}, this.blurred = !0, this.$original_element = a(c), this.document = c.ownerDocument, this.window = "defaultView" in this.document ? this.document.defaultView : this.document.parentWindow, this.$document = a(this.document), this.$window = a(this.window), this.br = this.browser.msie && a.Editable.getIEversion() <= 10 ? "" : "<br/>", this.init(c), a(c).on("editable.focus", a.proxy(function() {
    ...
    b.initializers = [], b.count = 0, b.VALID_NODES = ["P", "DIV", "LI", "TD", "TH"], b.LANGS = [], b.INVISIBLE_SPACE = "&#x200b;", b.DEFAULTS = {
        ...
        this.$placeholder && this.$placeholder.remove(), this.isLink ? this.$element.removeData("fa.editable") : (this.$wrapper ? this.$wrapper.replaceWith(this.getHTML(!1, !1)) : this.$element.replaceWith(this.getHTML(!1, !1)), this.$box && !this.editableDisabled && (this.$box.removeClass("froala-box f-rtl"), this.$box.find(".html-switch").remove(), this.$box.removeData("fa.editable"), clearTimeout(this.typingTimer)))
        ...
        if (!this.isHTML) {
            ...
            this.trackHTML !== a && null != this.trackHTML ? (this.refreshImageList(), this.refreshButtons(), this.trackHTML = a, this.$textarea && this.$textarea.val(this.getHTML(!1, !0)), this.doingRedo || this.saveUndoStep(), this.triggerEvent("contentChanged", [], !1)) : null == this.trackHTML && (this.trackHTML = a)
        }
        ...
        this.initEvents(), this.browserFixes(), this.handleEnter(), this.editableDisabled || (this.initUndoRedo(), this.enableTyping(), this.initShortcuts()), this.initTabs(), this.initEditor();
        ...
        b.contents().filter(function() {
            ...
            if (b.hasClass("f-marker") || b.find(".f-marker").length) {
                var k = b;
                b.find(".f-marker").length && (k = a(b.find(".f-marker")[0]));
                var l = k.prev();
                "true" === k.attr("data-type") ? l.length && a(l[0]).hasClass("f-marker") ? j = !0 : (h = !0, i = !1) : i = !0
            }
            this.nodeType == Node.TEXT_NODE && b.text().trim().length > 0 || e.indexOf(this.tagName) >= 0 ? d.push(this) : this.nodeType == Node.TEXT_NODE && 0 === b.text().trim().length && f.options.beautifyCode ? b.remove() : h || c || j ? ("BR" === this.tagName && (d.length > 0 ? b.remove() : d.push(this)), g(), i && (h = !1), j = !1) : d = []
        ...
        this.uploadPastedImages(), this.checkPlaceholder(), this.pasting = !1, this.triggerEvent("afterPaste", [], !0, !0)
        ...
        this.$element.on("copy cut", a.proxy(function() {
            b.copiedHTML = this.getSelectedHTML(), b.copiedText = a("<div>").html(b.copiedHTML).text()
            ...
            if (!this.isHTML) {
                ...
                if (b && b.clipboardData && b.clipboardData.getData) {
                    ...
                    else d = e; if (/text\/html/.test(d) ? this.clipboardHTML = b.clipboardData.getData("text/html") : /text\/rtf/.test(d) && this.browser.safari ? this.clipboardHTML = b.clipboardData.getData("text/rtf") : /text\/plain/.test(d) && !this.browser.mozilla && (this.clipboardHTML = b.clipboardData.getData("text/plain").replace(/\n/g, "<br/>")), "" !== this.clipboardHTML ? c = !0 : this.clipboardHTML = null, c) return this.processPaste(), b.preventDefault && (b.stopPropagation(), b.preventDefault()), !1
                }
                this.beforePaste()
            }
        }, this))
            ...
            if (c = a.charAt(d), "<" == c) {
                ...
                if (-1 !== k) {
                    var l = a.substring(d, k + 1),
                        m = this.tagName(l);
                    if (this.options.allowedTags.indexOf(m) < 0) {
                        d = k;
                        continue
                    }
                    if (0 === m.indexOf("!")) {
        ...
        var p = !0;
        for (d = 0; d < i.length; d++) 1 == i[d].length ? p && " " === i[d] || (a += i[d], p = !1) : g.indexOf(this.tagName(i[d]).toLowerCase()) < 0 ? (a += i[d], "br" == this.tagName(i[d]) && (a += o)) : this.isSelfClosingTag(i[d]) ? a += i[d] : this.isClosingTag(i[d]) ? (h -= 1, 0 === h && (p = !0), a.length > 0 && a[a.length - 1] == o && (a += this.tabs(h)), a += i[d] + o) : (a += o + this.tabs(h) + i[d], h += 1, p = !1);
        ...
        g || (g = a.merge([], this.options.allowedAttrs)), f || (f = a.merge([], this.options.allowedTags)), d || g.indexOf("id") > -1 && g.splice(g.indexOf("id"), 1), this.options.allowComments ? (this.options.allowedTags.push("!--"), this.options.allowedTags.push("!")) : c = c.replace(/<!--.*?-->/gi, ""), c = c.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, ""), c = c.replace(/<style\b[^<]*(?:(?!<\/style>)<[^<]*)*<\/style>/gi, "");
        ...
        if (!this.isHTML) {
            ...
            if ("" === this.text() && c && (0 === c.startOffset || c.startContainer === this.$element.get(0) || !this.inEditor(c.startContainer))) {
                ...
                if (c.startOffset > 0 && this.valid_nodes.indexOf(this.getSelectionElement().tagName) >= 0 || c.startContainer && 3 === c.startContainer.nodeType) return;
        ...
        return "" === b && 0 === this.$element.find("img, table, iframe, input, hr, li").length && 0 === this.$element.find(this.options.defaultTag + " > br, br").length && 0 === this.$element.find(a.map(this.valid_nodes, a.proxy(function(a) {
        ...
        return "" === c && b && 1 == a.find("br, li").length && 0 === a.find("img, table, iframe, input, hr, li").length
        ...
        for (var f = 0; f < e.length; f++) {
            ...
            if (g.parentsUntil(this.$element, "li").length > 0 && (g = g.closest("li")), this.raiseEvent("indent", [g, b]))
                if (g.get(0) != this.$element.get(0)) {
                    var h = parseInt(g.css("margin-left").replace(/px/, ""), 10),
                        i = Math.max(0, h + d);
                    g.css("marginLeft", i)
                } else {
                    var j = a("<div>").html(g.html());
                    g.html(j), j.css("marginLeft", Math.max(0, d))
                }
        }
...
function(a) {
    a.Editable.prototype.refreshImageAlign = function(a) {
        ...
        return dropdown = this.buildDefaultDropdown(a), btn = this.buildDropdownButton(a, dropdown)
        ...
        b.append(this.buildImageButtons()), this.addListener("hidePopups", this.hideImageEditorPopup), this.options.imageTitle && a('<div class="f-popup-line f-image-alt">').append('<label><span data-text="true">Title</span>: </label>').append(a('<input type="text">').on("mouseup keydown touchend", function(a) {
            var b = a.which;
            b && 27 === b || a.stopPropagation()
        })).append('<button class="fr-p-bttn f-ok" data-text="true" data-callback="setImageAlt" data-cmd="setImageAlt" title="test">OK</button>').appendTo(this.$image_editor),
            this.$popup_editor.append(this.$image_editor), this.bindCommandEvents(this.$image_editor), this.bindDropdownEvents(this.$image_editor)
...
function(a) {
    a.Editable.prototype.browserFixes = function() {
        this.backspaceEmpty(), this.fixHR(), this.domInsert(), this.fixIME(), this.cleanInvisibleSpace(), this.cleanBR(), this.insertSpace()
    }, a.Editable.prototype.insertSpace = function() {
        this.browser.mozilla && this.$element.on("keypress", a.proxy(function(a) {
            var b = a.which;
            this.isHTML || 32 != b || (a.preventDefault(), this.insertSimpleHTML("&nbsp;"))
        }, this))
        ...
        this.$element.on("keyup", a.proxy(function() {
            this.$element.find(this.valid_nodes.join(" > br:last, ") + " > br:last").each(a.proxy(function(b, c) {
                var d = a(c).prev();
                ["TH", "TD"].indexOf(a(c).parent().get(0).tagName) < 0 && d.length && "BR" != d.get(0).tagName && a(c).parent().text().length > 0 && this.isLastSibling(c) && a(c).remove()
            }, this))
        }, this))
...
function(a) {
    a.Editable.prototype.handleEnter = function() {
        ...
        return c && "A" != d.tagName && "BREAK" != d.tagName && (f = "<" + d.tagName + this.attrs(d) + ">" + f + "</" + d.tagName + ">"), this.options.paragraphy && (f = "<" + this.options.defaultTag + this.attrs(d) + ">" + f + "</" + this.options.defaultTag + ">"), c && (f = e + f), f
...
function(a) {
    ...
    a.Editable.prototype.hl = window.location, a.Editable.prototype.coreInit = function() {
        var a = this,
...
function(a) {
    a.Editable.DEFAULTS = a.extend(a.Editable.DEFAULTS, {
    ...
    }), a.Editable.TAG_ORDER = ["main", "section", "header", "footer", "article", "details", "legend", "summary", "table", "thead", "tbody", "tfoot", "tr", "th", "td", "ul", "ol", "li", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "p", "br", "a", "span", "strong", "em", "strike", "u", "iframe", "object", "param", "video", "source", "embed"], a.Editable.prototype.isClosingTag = function(a) {
        ...
        var h = function(b, c) {
            ...
            return [{
                ...
                for (b in d)
                    for (var h in d[b])
                        for (f = 0; f < d[b][h].length; f++)
                            if (e = d[b][h][f], !(e.selfClosing || e.dirty || e.shadow || e.comment))
                                for (var i = f + 1; i < d[b][h].length; i++)
                                    if (g = d[b][h][i], !(g.selfClosing || g.dirty || g.shadow || g.comment || 1 != Object.keys(e.styles).length || 1 != Object.keys(g.styles).length || g.sp == g.ep)) {
                                        var j = Object.keys(e.styles)[0];
                                        if (g.styles[j]) {
                                            e.sp = g.ep;
                                            for (var k = 0; k < d[e.sp][e.tagName].length; k++) {
                                                var l = d[e.sp][e.tagName][k];
                                                if (l.shadow && l.ci == g.ci) {
                                                    d[e.sp][e.tagName].splice(k, 0, e);
                                                    break
                                                }
                                            }
                                            d[b][h].splice(f, 1), f--;
                ...
                for (b = 0; b < c.length; b++)
                    if (e = c[b], !e.dirty && !e.selfClosing && !e.comment)
                        if (e.sp == e.ep && a.isEmptyObject(e.attrs) && a.isEmptyObject(e.style)) e.dirty = !0;
                        else if (d[e.ep] && d[e.ep][e.tagName])
                    for (f = 0; f < d[e.ep][e.tagName].length; f++)
                        if (g = d[e.ep][e.tagName][f], !g.dirty && e != g && !e.selfClosing && !g.shadow && !g.comment && a.isEmptyObject(g.attrs) && JSON.stringify(g.styles) == JSON.stringify(e.styles)) {
                            e.ep = g.ep, g.dirty = !0, b--;
                            break
                        }
                for (b = 0; b < c.length; b++)
                    if (e = c[b], !e.dirty && !e.selfClosing && !e.comment)
                    ...
                    for (f = d[e.sp][e.tagName].length - 1; f >= 0; f--) g = d[e.sp][e.tagName][f], g.dirty || e != g && (e.selfClosing || g.shadow || g.comment || e.ep == g.ep && a.isEmptyObject(g.attrs) && (e.styles = a.extend(e.styles, g.styles), g.dirty = !0))
            };
        i(b, 0), j();
        ...
        var d, e, f, g;
        c && a(b).html(a(b).html().replace(/\u200B/gi, ""));
        ...
        var e;
        if (this.isHTML) return !1;
        void 0 === b && (b = !0), void 0 === d && (d = !0), this.no_verify = !0, this.$element.find("span").removeAttr("data-fr-verified"), d && this.saveSelectionByMarkers(), b ? e = this.getSelectionElements() : (e = this.$element.find(this.valid_nodes.join(",")), 0 === e.length && (e = [this.$element.get(0)]));
        var f, g;
        ...
        this.$element.find("[data-fr-idx]").removeAttr("data-fr-idx"), this.$element.find(".f-marker").html(""), d && this.restoreSelectionByMarkers(), this.$element.find("span").attr("data-fr-verified", !0), this.no_verify = !1
    }
